...
tsc -v
Version 4.8.2
//初始化,生成tsconfig.json配置文件,解决TS和JS冲突问题
tsc --init
```
...
# 2.测试代码
1.根目录下创建 `src/main.ts` 的文件，代码如下：

```typescript
var title:string = "林扬生";
console.log(title);
```

2.执行命令将 TypeScript 转换为 JavaScript 代码：
...
//编译为src/main.js
tsc src/main.ts
//监听变化,自动编译,编译为dist/main.js
tsc --watch
//发出错误
tsc -noEmitOnError src/main.ts
```

3.根目录下`src`文件夹内生成 `main.js` 文件
