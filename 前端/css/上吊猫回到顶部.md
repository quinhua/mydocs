<img src="https://git.poker/quinhua/pics/blob/main/za/nbhjuytrdcxvgbhy765redscxv.webp?raw=true" />
...
@media (max-width:1000px) {
  ...
  .back-to-top {
    ...
    width: 70px;
    height: 900px;
    background: url(https://git.poker/quinhua/pics/blob/main/za/goTopCat.gif?raw=true);
